...
def train(args, model, criterion, optimizer, device, train_dataloader, writer, epoch):
    ...
    for i, data in enumerate(train_dataloader, 1):
        ...
        if i % args.pf == 0:
            ...
            print('[TRAIN] epoch-{}, batch-{}, loss: {:.3f}, acc: {:.3f}'.format(epoch, i, avg_loss, avg_acc), end='\r')
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':  ########### Train #############
        if args.ckpt:  # resume training
            ...
            if args.desp:
                exp_name = '{}_scratch_{}_cl{}_{}_{}'.format(args.model, args.modality, args.cl, args.desp, time.strftime('%m%d'))
            else:
                exp_name = '{}_scratch_{}_cl{}_{}'.format(args.model, args.modality, args.cl, time.strftime('%m%d'))
        ...
        #validate(args, model, criterion, device, test_dataloader)
